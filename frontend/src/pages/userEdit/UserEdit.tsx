...
const UserEdit:React.FC = () => {
    ...
    const [formdata, setFormdata] = useState<{vorname:string, nachname:string, username:string, email:string, street:string, number:string,plz:string, city:string}>({
        vorname:"",
        nachname:"",
        username:"",
        email:"",
    ...
    const {vorname, nachname, username, email, street, number, plz, city} = formdata;
